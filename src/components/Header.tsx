  ...
  return (
    <header className="min-h-[70px] h-[70px] px-4 py-2.5 border-b border-stone-200 flex justify-between items-center bg-transparent shrink-0">
      <Link to="/" className="flex items-center gap-2.5 min-w-0">
        <span
          className="shrink-0 w-10 h-10 min-w-10 min-h-10 inline-flex items-center justify-center bg-stone-100 rounded-lg overflow-hidden"
          aria-hidden
        >
          <img
            src="/vite.svg"
      ...
      <nav className="flex items-center gap-1 shrink-0">
        ...
        {isAuth ? (
          <>
            ...
            <div className="relative ml-2" ref={dropdownRef}>
              ...
              >
                ...
                <ChevronDown
                  size={16}
                  className="text-stone-500 hidden sm:block"
                  aria-hidden
                />
              </button>
              {dropdownOpen && (
          ...
          <>
            {authError && (
              <p
                className="text-xs text-red-600 mr-2 max-w-[140px] truncate"
                title={authError}
              >
                {authError}
              </p>
